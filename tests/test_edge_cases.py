...
class TestEdgeCasesTimeHandling:
    ...
    def test_calculate_delay_edge_cases(self):
        ...
        assert (
            calculate_delay("23:59", "00:01") == -1438
...
class TestErrorRecoveryScenarios:
    ...
    def test_partial_data_corruption(self):
        ...
        with (
            patch("app.os.path.exists", return_value=True),
            patch(
                "builtins.open", mock_open(read_data=json.dumps(partially_corrupted))
            ),
        ):
    ...
    def test_memory_pressure_simulation(self):
        ...
        with (
            patch("app.os.path.exists", return_value=True),
            patch(
                "builtins.open", mock_open(read_data=json.dumps(memory_intensive_data))
            ),
        ):
    ...
    def test_concurrent_access_simulation(self):
        ...
        def side_effect_incomplete_read(*args: Any, **kwargs: Any) -> Any:
            ...
            return mock_open(read_data='{"badVoeslauToWien": [{"ti": "10:17"')(
                *args, **kwargs
            )
